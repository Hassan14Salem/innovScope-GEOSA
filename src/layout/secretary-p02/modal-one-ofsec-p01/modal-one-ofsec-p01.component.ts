...
@Component({
  selector: 'app-modal-one-ofsec-p01',
  templateUrl: './modal-one-ofsec-p01.component.html',
  styleUrls: ['./modal-one-ofsec-p01.component.css']
})
export class ModalOneOfsecP01Component {
